...
/* ============================================================
   Main Render — ใช้ safeRender() ครอบทุกฟังก์ชัน
   ============================================================ */
function render() {
  ...
  safeRender('renderBudgets',     () => renderBudgets(sums));
...
/* ---------- Budgets v2 — มี guard ป้องกัน ---------- */
function renderBudgets(sums) {
  // ✅ Guard 1: element ต้องมี
  const el = document.getElementById('budgetList');
  if (!el) return;

  // ✅ Guard 2: DATA ต้องพร้อม
